...
import { BarChart3, BookOpen, HardDriveDownload, LayoutDashboard, Library, ListPlus, Moon, Plus, Quote, Sun } from "lucide-react";
...
export function CommandPalette() {
  ...
  const { commandOpen, setCommandOpen, setQuickAddOpen, setBulkAddOpen, setBackupOpen } = useUI();
          ...
          <Command loop filter={matchAllWords}>
            ...
            <CommandList>
              ...
              <CommandGroup heading="Actions">
                ...
                <CommandItem value="backup restore icloud copies save file" onSelect={() => run(() => setBackupOpen(true))}>
                  <HardDriveDownload className="size-4 text-muted-foreground" /> Backup and restore
                </CommandItem>
                <CommandItem
